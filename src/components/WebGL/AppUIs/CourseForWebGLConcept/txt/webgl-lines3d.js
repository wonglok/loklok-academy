...
window.addEventListener('DOMContentLoaded', function(){
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    linesSegments.a_position_array,
    gl.DYNAMIC_DRAW);


  var a_position_location = gl.getAttribLocation(program, 'a_position');
  gl.enableVertexAttribArray(a_position_location);
  gl.vertexAttribPointer(a_position_location, linesSegments.a_position_numberOfDataPerVectex, gl.FLOAT, false, 0, 0);
  ...
  var rAF = function () {
    ...
    gl.drawArrays(gl.LINES, 0, linesSegments.a_position_numberOfVertex);
